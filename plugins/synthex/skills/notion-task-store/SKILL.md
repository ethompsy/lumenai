---
name: notion-task-store
description: "Use the Synthex Notion Task Store specialist. Trigger for direct notion task store work or when another Synthex workflow delegates to the notion-task-store agent."
---

<!-- Generated by scripts/generate-codex-skills.mjs; do not edit. -->

# Synthex Notion Task Store
...
1. Read [`./agents/notion-task-store.md`](../../agents/notion-task-store.md) completely before acting.
