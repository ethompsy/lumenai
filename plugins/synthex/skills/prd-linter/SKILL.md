---
name: prd-linter
description: "Use the Synthex PRD Linter specialist. Trigger for direct prd linter work or when another Synthex workflow delegates to the prd-linter agent."
---
...
1. Read [`./agents/prd-linter.md`](../../agents/prd-linter.md) completely before acting.
